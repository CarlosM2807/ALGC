...
def dijkstraFrontera(graph,inicio,destino):
    dist = {}
    prev = {}
...
menor_distancia,currentNode,predecesores = dijkstraFrontera(graph,habitacionInicio,habitacionFin)   # SE LLEVA A CABO EL ALGORITMO
...
if(sepuede == True):
    ...
    print("\nEl tiempo del algoritmo DIJKSTRA CON FRONTERA es: ",t1, " segundos")
